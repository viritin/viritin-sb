...
Create a new project with an archetype (CLI or with IDE):
    ...
    mvn archetype:generate -DinteractiveMode=false -DgroupId=org.example -DartifactId=my-great-project -Dversion=1.0-SNAPSHOT -DarchetypeGroupId=in.virit -DarchetypeArtifactId=viritin-vaadin-flow-spring-archetype -DarchetypeVersion=2.6

Or....

Create a project or modify existing to use parent:

    in.virit.sb:project-parent:0.0.11

or...

    in.virit.sb:viritin-project-parent:0.0.11
